...
CREATE TABLE stations (station_id integer, name character varying(50), number integer, lat numeric, lng numeric, bike_stands integer, address character varying(50), code_insee integer, commune character varying(20), PRIMARY KEY (station_id) );
